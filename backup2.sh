...
cp -r /var/lib/izhanworks/ /root/backup/izhanworks &> /dev/null
...
LLatest=`date`
Get_Data () {
git clone https://github.com/izhanworks/user-backup-db.git /root/user-backup/ &> /dev/null
}
...
Save_And_Exit () {
    ...
    git push -f https://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@github.com/izhanworks/user-backup-db.git &> /dev/null
}
...
link="https://raw.githubusercontent.com/izhanworks/user-backup-db/main/$NameUser/$NameUser.zip"
sleep 1
